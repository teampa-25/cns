...
from .icra2018_large import ICRA2018Large


def compute_train_loss(net: ICRA2018Large, data, device):
    """
    Arguments:
    - net: torch.nn.Module
...
def compute_eval_score(net: ICRA2018Large, data, device):
    """
    Arguments:
    - net: torch.nn.Module
    - data: data from (for data in dataloader)
